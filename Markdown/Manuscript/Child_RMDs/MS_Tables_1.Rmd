...
---
```{r proscons, tab.cap='Implications of choosing proprietary software or an open-source programming language for the computational implementation of health economic models', tab.id = 'proscons', echo = F, results = 'asis'}
library(kableExtra)  
df <- data.frame(`Implications` = c(rep("Resources",4), rep("Ethical",10)),
                 `Proprietary modelling or spreadsheet software` = c("(+) Will include tools to efficiently accomplish many common modelling tasks.",
                                                     ...
                                                     "(-) Manual transfer of results to manuscripts through copy and paste or transcription from visual inspection increases risk of (undetected) reporting errors.",
                                                     "",
                                                     "Reusability",
                 ...
                 `Open-source programming language` = c("(-) Initial development is likely to be time and resource intensive.",
                                                        ...
                                                        "(ii)	models are to be maintained and transferred (e.g. to new decision problems / contexts).",
                                                        "Transparency",
...
if(params$X@outp_formats_chr[1] == "Word") {
  ...
  df %>%
    ...
    df %>%
      dplyr::filter(!`Proprietary modelling or spreadsheet software` %in% c("Transparency", "Reusability","Updatability")) %>%
