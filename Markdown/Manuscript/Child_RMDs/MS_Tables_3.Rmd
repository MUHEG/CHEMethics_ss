...
df <- tibble::tibble(Package = c("ready4",
                                       ...
                                       "ready4use",
                                       "ready4show"),
                     Purpose = c("Provides a template model module and novel syntax and tools for finding interoperable CHEM modules, datasets and reproducible analysis programs.",
                                 "Streamline and standardise the authoring and documenting of functions that support selective reuse of model algorithms.",
                                 "Streamline and standardise the authoring and documenting of new CHEM modules.",
                                 "Help bundle and disseminate CHEM modules as documented, licensed and quality assured  R libraries.",
                                 "Help manage the labelling and transfer of data between CHEM modules and local and remote data repositories.",
                                 "Support the authoring of programs that implement integrated and reproducible data ingest, analysis and reporting pipelines."),
                           # A = c("3","2-3","2","1-2,5,7","1-2,7","4,6"), 
                           # R = c("4","5","4-5","1,3,6","3,7",""),
                           # U = c("","","","1-3","1",""),
                           `R library dependencies` = Package %>%
                             purrr::map(~ {
